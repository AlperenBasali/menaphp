        ...
        <div id="carouselExampleInterval" class="carousel slide w-75 m-auto" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active" data-bs-interval="5000">
                <img src="imgslayt/SLAYT1.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item" data-bs-interval="2000">
                <img src="imgslayt/slayt2.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="imgslayt/slayt3.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="imgslayt/dus-1" class="d-block w-100" alt="...">
              </div>
            </div>
